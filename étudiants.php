...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <a href="ajouter_étudiant.php" class="btn btn-success btn-fill pull-left" style="margin-left: 0.80cm;"><i class="fas fa-plus"></i> Ajouter un nouveau étudiant</a>
...
WHERE role = 'etudiant'";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="details_étudiant.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-fill"><i class="far fa-eye"></i></a>
                                                        <a href="modifier_étudiant.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-fill"><i class="fas fa-pencil-alt"></i></a>
    ...
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "supprimer_étudiant.php?id=" + id;
            }
        });
    }
</script>
