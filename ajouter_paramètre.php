...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO parametres (date_debut, date_fin, date_de_creation) VALUES ('$date_debut', '$date_fin', NOW())";

    if ($conn->query($sql) === TRUE) {
        $message = "La date a été ajouté avec succès!";
    } else {
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title"><i class="fas fa-plus" style="margin-right: 10px;"></i>Ajouter un nouveau date de dépôt de rapport</h4>
                                </div>
                                <div class="content">
