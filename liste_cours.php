...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <a href="ajouter_cours.php" class="btn btn-success btn-fill pull-left" style="margin-left: 0.80cm;"><i class="fas fa-plus"></i> Ajouter un cours</a>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="modifier_cours.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-fill"><i class="fas fa-pencil-alt"></i></a>
...
<script>
    function confirmDelete(id) {
        Swal.fire({
            title: 'Êtes-vous sûr ?',
            text: "Cette action supprimera définitivement ce cours !",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                window.location.href = "supprimer_cours.php?id=" + id;
            }
        });
    }
</script>
