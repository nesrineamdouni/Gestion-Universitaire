...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <a href="ajouter_classe.php" class="btn btn-success btn-fill pull-left" style="margin-left: 0.80cm;"><i class="fas fa-plus"></i> Ajouter une nouvelle classe</a>
                            ...
                            <div class="card">
                                <div class="content table-responsive table-full-width">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $sqlfetsh = "SELECT * FROM `classe` order by id asc";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="modifier_classe.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-fill"><i class="fas fa-pencil-alt"></i></a>
