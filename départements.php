...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <a href="ajouter_département.php" class="btn btn-success btn-fill pull-left" style="margin-left: 0.80cm;"><i class="fas fa-plus"></i> Ajouter un nouveau département</a>
                            ...
                            <div class="card">
                                <div class="content table-responsive table-full-width">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $sqlfetsh = "SELECT * FROM `departement` order by id asc";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="modifier_département.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-fill"><i class="fas fa-pencil-alt"></i></a>
...
<script>
    function confirmDelete(id) {
        Swal.fire({
            title: 'Êtes-vous sûr ?',
            text: "Cette action supprimera définitivement ce département !",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                window.location.href = "supprimer_departement.php?id=" + id;
            }
        });
    }
</script>
